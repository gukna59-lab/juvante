                   ...
                   <div id="anime-player-section" className="bg-[#11141A] rounded-3xl border border-[#1F2937] overflow-hidden scroll-mt-24">
                      ...
                      <div className="p-6 bg-[#0A0C10]">
                         ...
                         <form onSubmit={handlePostComment} className="flex gap-3 mb-6">
                            <div className="w-10 h-10 rounded-full bg-[#1E293B] overflow-hidden shrink-0 border border-[#1F2937]">
                            ...
                            <div className="flex-1">
                               {commentMediaUrl && (
                                  <div className="relative w-32 h-32 mb-2 rounded-xl overflow-hidden border border-[#1F2937] group">
                               ...
                               <div className="relative">
                                  <input 
                                     ...
                                     className="w-full bg-[#11141A] border border-[#1F2937] rounded-xl pl-4 pr-[140px] py-2.5 text-sm focus:border-blue-500/50 outline-none transition-colors" 
                                  />
                         ...
                         <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                            {comments.length === 0 ? (
                               ...
                               <div key={comment.id} className="flex gap-3">
                                  <div className="w-8 h-8 rounded-full bg-[#1E293B] overflow-hidden shrink-0 border border-[#1F2937]">
                                  ...
                                  <div className="flex-1 bg-[#11141A] rounded-2xl rounded-tl-sm p-3 border border-[#1F2937]">
                                     ...
                                     {comment.mediaUrl && comment.mediaType === 'image' && (
                                        <div className="mt-2 rounded-lg overflow-hidden border border-[#1F2937] max-w-sm">
